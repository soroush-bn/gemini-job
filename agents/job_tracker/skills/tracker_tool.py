...
def update_job_tracker_table(job_name: str, company: str, role: str, date_posted: str, deadline: str, status: str, folder_path: str, url_hash: str = "", apply_links: str = ""):
    """Appends a new job to the Markdown tracker table."""
    headers = "| Job Name | Company Name | Role | Date Posted | Deadline | Status | URL Hash | Apply Links | Path |\n"
    separator = "| --- | --- | --- | --- | --- | --- | --- | --- | --- |\n"
    ...
    new_row = f"| {job_name} | {company} | {role} | {date_posted} | {deadline} | {status} | {url_hash} | {apply_links} | [{rel_path}]({rel_path}) |\n"
